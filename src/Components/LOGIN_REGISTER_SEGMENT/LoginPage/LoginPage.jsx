...
// code is just logged in but getting issue upper code have working 
// import React, { useState } from "react";
// import { Phone, Lock, Loader2, Eye, EyeOff } from "lucide-react";
// import { toast } from "react-toastify";
...
//     setLoading(true);
//     try {
//       const res = await wholesaleAxios.post("/auth/login", {
//         identifier: form.mobileOrEmail.trim(),
//         password:   form.password,
//       });
...
//       toast.success(`Welcome back, ${user?.name ?? "Wholesaler"}! 🎉`);
