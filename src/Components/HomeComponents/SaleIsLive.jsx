...
const SaleIsLive = () => {
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-4 sm:px-8 py-10">
      {/* Header */}
      <div className="flex flex-col justify-between items-start gap-4 mb-10">
        <div className="space-y-1">
         ...
         <div className='flex items-center justify-between w-full'>
          ...
          <Link to="/on-sale" className='flex items-center gap-2 text-[0.8rem] font-bold text-yellow-500 uppercase tracking-widest group bg-white px-4 py-2 transition-all cursor-pointer shadow-sm disabled:opacity-50'>View All</Link>
          </div>
      </div>
  ...
  <div className="flex justify-center mt-10">
    <button
      ...
      disabled={isFetching}
      className="flex items-center gap-2 text-[0.8rem] font-bold text-[#0F172A] uppercase tracking-widest group bg-white border border-slate-200 px-4 py-2 hover:bg-[#0F172A] hover:text-white transition-all shadow-sm disabled:opacity-50"
    >
